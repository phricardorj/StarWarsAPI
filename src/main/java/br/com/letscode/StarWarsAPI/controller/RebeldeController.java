...
import br.com.letscode.StarWarsAPI.model.Genero;
...
public class RebeldeController {
    ...
    public List<Rebelde> listaRebeldes(){
        ...
        Rebelde r1 = new Rebelde(UUID.randomUUID(),"Rebelde 1", 28, Genero.MASCULINO, l1, i1);

        Localizacao l2 = new Localizacao(-21.1234, -56.2345, "Galáxia de Andrômeda");
        Inventario i2 = new Inventario(5,35,2,1);
        Rebelde r2 = new Rebelde(UUID.randomUUID(),"Rebelde 2", 24, Genero.FEMININO, l2, i2);
